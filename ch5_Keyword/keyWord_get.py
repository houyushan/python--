...
def train_idf(doc_list):
    ...
    # 按公式转换为idf值，分母加一进行平滑处理
    for k, v in idf_dic.items():
        idf_dic[k] = math.log(tt_count / (1.0 + v))
    # 对于没有在字典中出现的词，默认其仅在一个文档出现，得到默认idf值
...
class TfIdf(object):
    ...
    def __init__(self, idf_idc, default_idf, word_list, keyword_num):
        ...
        self.idf_dic, self.default_idf = idf_idc, default_idf
    ...
    def get_tfidf(self):
        ...
        for word in self.word_list:
            ...
            tfidf = tf * idf  # 计算可能为关键词概率 模型中该词的频率*文本中该词的频率
