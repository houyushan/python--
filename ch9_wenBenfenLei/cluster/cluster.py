...
cluster_datails = get_cluster_data(clustering_obj=km_obj, book_data=book_data, feature_names=feature_names,
                                   num_clusters=num_clusters, topn_features=10)
for i in cluster_datails.items():
    print(i)
